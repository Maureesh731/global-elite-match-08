...
export const FullApplicationModal: React.FC<FullApplicationModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!agreed) return;
    // Ideally, validate here for "medicalFile" date (must be within 30 days), skip for demo.
      ...
      <DialogContent className="max-w-lg">
        ...
        {showSubmitSuccess ? (
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              <Button type="submit" className="w-full text-lg bg-blue-900 hover:bg-blue-800" disabled={!agreed}>
                Submit Application
              </Button>
            </DialogFooter>
          </form>
